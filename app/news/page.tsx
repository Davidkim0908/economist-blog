...
export default function NewsPage() {
  ...
  const newsItems = [
    ...
    },
    {
      ...
      quote: "\"플랫폼 스스로 새로운 서비스 출시를 고민하도록 만들 유인책을 고민해야 합니다. 특히 타입2(플랫폼 운송사업)에서 중개 서비스와 차별화된 서비스가 운영될 수 있도록 제도를 손볼 필요가 있습니다.\"",
      link: "https://biz.chosun.com/policy/policy_sub/2024/02/07/LBTWTPK6KFFRFHWSLHOHXN46YU/"
    }
  ];
