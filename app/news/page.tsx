  ...
  const newsItems = [
    {
      date: "2026.02.25",
      media: "매일경제",
      title: "AI 도입했는데 왜 생산성은 그대로일까? '진짜 성장'을 위한 조직 혁신 전략",
      coreSummary: "AI 도입이 생산성 증대로 이어지기 위해서는 기술 자체보다 데이터 사일로 해소와 조직 문화 개선 등 무형자산에 대한 보완 투자가 선행되어야 합니다.",
      fullSummary: "정부와 기업이 AI를 통한 경제 재도약을 노리고 있지만, 단순한 비용 절감형 AI 도입은 성장의 한계가 뚜렷합니다. 생산성 J-커브를 그리기 위해서는 낡은 프로세스를 재설계하고 인력을 재훈련하는 등 보이지 않는 자산에 대한 투자가 임계점을 넘어야 합니다.",
      quote: '"AI 실패 원인의 70%는 사람과 프로세스에 있습니다. 기업은 데이터 생태계를 구축하고 AI와 인간이 공존할 수 있는 보상 체계를 마련해야 합니다."',
      link: "https://www.mk.co.kr/news/business/11971782"},
    {
      date: "2026.01.16",
      media: "뉴스1",
