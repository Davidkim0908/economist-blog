...
export default function NewsPage() {
  ...
  const newsItems = [
    ...
    },
    {
      date: "2024.05.30",
      media: "조선비즈",
      title: "'법인택시 월급제' 전국 시행 앞두고… 갈등과 우려 교차",
      coreSummary: "법인택시 월급제의 전국 확대를 앞두고 업계 내부의 갈등과 지역별 수급 불균형에 대한 우려가 깊어지고 있습니다.",
      fullSummary: "정해진 시간에 맞춰 급여를 지급하는 택시 월급제가 전국 시행을 앞두고 노사 간, 그리고 노노 간 갈등의 핵으로 떠올랐습니다. 특히 서울과 달리 인구가 감소하고 고령화가 진행된 지방 도시의 경우, 경직된 임금 체계가 오히려 택시 공급을 위축시킬 수 있다는 지적입니다. 시장의 수요 변화에 대응하기 위한 유연한 제도 개편이 시급한 과제로 제기되었습니다.",
      quote: "\"월급제 시행의 진짜 문제는 서울 외 지역에서 나타날 것입니다. 인구 감소와 고령화에 직면한 지역들이 경직적인 임금 체계를 감당하기는 매우 어렵습니다. 유연한 임금 체계를 위한 법 개정이 선행되어야 합니다.\"",
      link: "https://biz.chosun.com/policy/policy_sub/2024/05/30/M62WHFMEANEX3A6BB56JIA4MJ4/"
    },
    {
      date: "2024.03.27",
      media: "이데일리",
